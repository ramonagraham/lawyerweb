    ...
    <div id="main">
        ...
        <section id="one" class="tiles">
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">The Firm</a></h3>
            ...
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">Real Estate</a></h3>
            ...
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">Business Organization</a></h3>
            ...
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">Estate Planning</a></h3>
            ...
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">Commercial Transactions</a></h3>
            ...
            <article>
                ...
                <header class="major">
                    <h3><a href="landing.php" class="link">Blog</a></h3>
